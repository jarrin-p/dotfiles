...
--- @param args.line, args.col (integer) line and col number of what is to be inspected, respectively.
--- @param args.trans (float) the transparency of the item
--- @param args.mode (string) 'gui', 'cterm', or 'term' for specifying which type of field you want.
