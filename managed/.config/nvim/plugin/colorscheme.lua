...
local darker = util.get_colorscheme_as_hex('Normal', 'background')
-- local darker = util.get_colorscheme_as_hex('FloatBorder', 'background')

local green = util.get_colorscheme_as_hex('HardHackerGreen', 'foreground')
local red = util.get_colorscheme_as_hex('HardHackerRed', 'foreground')
local orange = util.get_colorscheme_as_hex('HardHackerYellow', 'foreground')
