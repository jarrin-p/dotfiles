...
set_hl(0, 'StatuslineDirectory', {
    italic = 1,
    fg = util.get_colorscheme_as_hex('Comment', 'foreground'),
    bg = M.darker,
})
...
M.buffer_types = {
    terminal = M.header:set '  Terminal  ' .. M.transitions.header_to_dir,
}
M.file_types = {
    minimap = M.header:set '  Minimap  ' .. M.transitions.header_to_dir,
    help = M.header:set '  Help  ' .. M.transitions.header_to_dir,
    qf = M.header:set '  Quick Fix || Location List  '
        .. M.transitions.header_to_dir,
    fugitive = M.header:set '  Fugitive  ' .. M.transitions.header_to_dir
        .. M.dir_git,
    gitcommit = M.header:set '  Commit  ' .. M.transitions.header_to_dir
        .. M.dir_fug .. M.dir_git,
    git = M.header:set '  Branch  ' .. M.transitions.header_to_dir .. M.dir_fug
        .. M.dir_git,
}
