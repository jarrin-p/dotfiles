...
;; [s]ymbol [w]orkspace
(nnoremap :gsw ":lua vim.lsp.buf.workspace_symbol()<enter>")

;; [s]ymbol [d]ocument
(nnoremap :gsd ":lua vim.lsp.buf.document_symbol()<enter>")

;; [s]ymbol [o]utline
(nnoremap :gso ":SymbolsOutline<enter>")
